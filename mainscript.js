...
const Pin = () => {
    ...
    return (React.createElement("div", { id: "app-pin-wrapper" },
        React.createElement("input", { disabled: userStatus !== UserStatus.LoggingIn && userStatus !== UserStatus.LogInError, id: "app-pin-hidden-input", maxLength: 8, ref: ref, type: "number", value: pin, onChange: handleOnChange }),
...
const Tools = () => {
    ...
    return (React.createElement(MenuSection, { id: "tools-section", title: "" }, getTools()));
};
const Restaurants = () => {
    ...
    return (React.createElement(MenuSection, { id: "restaurants-section", title: "" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [].map((movie) => {
    ...
    return (React.createElement(MenuSection, { id: "movies-section", scrollable: true, title: "" }, getMovies()));
};
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "pagepremium1.html", target: "_blank" },
    ...
    return (React.createElement(AppContext.Provider, { value: { userStatus, setUserStatusTo } },
        React.createElement("div", { id: "app", className: getStatusClass() },
            ...
            React.createElement("div", { id: "sign-in-button-wrapper" },
                React.createElement(UserStatusButton, { icon: "fa fa-user-plus", id: "sign-in-button", userStatus: UserStatus.LoggingIn })),
